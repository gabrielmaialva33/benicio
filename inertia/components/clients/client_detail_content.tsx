  ...
  return (
    <div className="space-y-6" data-testid="client-detail">
      ...
      <section className="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-card sm:p-6">
        <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex min-w-0 items-start gap-4">
            <Button variant="outline" mode="icon" asChild aria-label="Voltar para clientes">
              <Link href="/clients">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="flex items-center gap-3 rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-card">
          <span className="flex size-11 items-center justify-center rounded-xl bg-orange-50 text-[#f97316] dark:bg-orange-500/10">
        ...
        <div className="flex items-center gap-3 rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-card">
          <span className="flex size-11 items-center justify-center rounded-xl bg-emerald-50 text-emerald-600 dark:bg-emerald-500/10">
      ...
      <div className="grid items-start gap-6 xl:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)]">
        <section className="rounded-2xl border border-slate-200/80 bg-white shadow-sm dark:border-white/10 dark:bg-card">
          <header className="border-b border-slate-100 px-5 py-4 dark:border-white/10">
            <h2 className="font-bold text-slate-900 dark:text-white">Pastas do cliente</h2>
          </header>
          {folders.length === 0 ? (
            ...
            <div className="divide-y divide-slate-100 dark:divide-white/10">
              {folders.map((folder) => (
                <Link
                  ...
                  className="flex items-start justify-between gap-4 px-5 py-4 transition hover:bg-orange-50/30 dark:hover:bg-white/[0.025]"
                >
        ...
        <div className="space-y-6">
          <section className="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-card">
            <h2 className="font-bold text-slate-900 dark:text-white">Contato</h2>
            <dl className="mt-5 grid gap-5">
              <Definition label="E-mail">
                {client.email ? (
                  <a
                    href={`mailto:${client.email}`}
                    className="inline-flex items-center gap-2 text-cyan-700 hover:underline dark:text-cyan-300"
                  >
          ...
          <section className="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-card">
            <h2 className="font-bold text-slate-900 dark:text-white">Observações</h2>
