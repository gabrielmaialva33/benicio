...
export type ProcessInstance = 'first' | 'second' | 'superior'
export type ProcessPhase = 'knowledge' | 'execution' | 'appeal' | 'sentence_compliance'
export type ProcessDistributionType = 'lottery' | 'dependency' | 'prevention'
export type ProcessPartySide = 'active' | 'passive' | 'third' | 'other'
export type ProcessPartyPersonType = 'individual' | 'company'
